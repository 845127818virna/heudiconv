...
# 20230321 Yuexin Xi taken from python3.9, modified for heudiconv
import operator
import warnings
...
from nibabel.onetime import auto_attr as one_time
from nibabel.openers import ImageOpener
from nibabel.nicom import csareader as csar
from nibabel.nicom.dwiparams import B2q, nearest_pos_semi_def, q2bg
...
class Wrapper:
    ...
    * series_signature : tuple
    ...
    def _scale_data(self, data):
        # q ending on pydicom and dicom files, values might need casting from
        # Decimal to float
